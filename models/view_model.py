...
class ViewModel:
    def __init__(self, items: List[Card], lists: List[CardList], show_all_done_items: bool = True, today: date = None, user_role: Role = Role.READER):
